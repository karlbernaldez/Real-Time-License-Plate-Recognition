...
def annotation(lp_bbox):
    ...
    for each in lp_bbox:
        xplate1, yplate1, xplate2, yplate2, lp_track_id, lp_score, class_name, track_id, car_img_name = each
        ...
        if lp_score >= 0.1:
            ...
            if license_plate_text is not None and license_plate_text_score is not None:
                ...
                # Save a cropped image of the license plate
        ...
        for detection in vehicle_detection.boxes.data.tolist():
            ...
            if len(detection) == 7:
                ...
                if int(class_id) in vehicles:
                    ...
                    car_img_name = f'{class_name}{track_id}.jpg'
                    ...
                    vehicle_bboxes.append([int(track_id), xvehicle1, yvehicle1, xvehicle2, yvehicle2, vehicle_score, class_name, car_img_name])  # store class name instead of class id
                ...
                for license_plate in license_detections.boxes.data.tolist():
                    ...
                    if len(license_plate) == 7:
                        ...
                        for veh_bbox in vehicle_bboxes:
                            ...
                            xvehicle1, yvehicle1, xvehicle2, yvehicle2, track_id, vehicle_score, class_name, car_img_name = veh_bbox
                            ...
                            if xplate1 > xvehicle1 and xplate2 > xvehicle2 and yplate1 < yvehicle1 and yplate2 < yvehicle2:
                                ...
                                lp_bbox.append([xplate1, yplate1, xplate2, yplate2, lp_track_id, lp_score, class_name, track_id, car_img_name])
